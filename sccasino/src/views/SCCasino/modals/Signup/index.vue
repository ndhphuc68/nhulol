<template>
  <div class="signup-main d-flex flex-md-row justify-content-between">
    <div class="signup-image-desktop">
      ...
      <div class="content">
        <div class="general">{{ $t("generalInfomation") }}</div>
        <div :class="`bank-account ${tab === 1 ? 'opacity' : ''}`">
    ...
    >
      <span class="title-signup">{{ $t("register") }}</span>
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li
                  ...
                  :key="index"
                  @click="
                    handleSelectOption($t(option.name));
...
const handleNextForm = () => {
  ...
  validateSignUp();
  if (
    errorSignUp.value.account &&
    errorSignUp.value.password &&
    errorSignUp.value.confirm_password &&
    errorSignUp.value.phone &&
    errorSignUp.value.withdraw_password
  ) {
    return;
  } else {
    tab.value = 2;
...
const handleSelectOption = (option) => {
  selectOption.value.name = option;
  dataSignUp.value.bank_name = selectOption.value.name;
};
