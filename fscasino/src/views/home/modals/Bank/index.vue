<script setup>
import {bankMenu} from "@/views/home/modals/Bank/data";
...
const getIcon = (idx) => {
  return require("@/assets/bank/banklogo_" + (idx + 1) + ".png");
};
...
<template>
  <div class="bank-main mt-4">
    <div class="row mb-3 bank-header">
      ...
      <div class="col-md-4 col-6"><span class="title-bank">PICK BANK</span></div>
      <div class="col-4"></div>
    </div>
    <hr/>
    <div class="row overflow-y-scroll list-bank">
      <span>Please check the wrong information or missing information.</span>
