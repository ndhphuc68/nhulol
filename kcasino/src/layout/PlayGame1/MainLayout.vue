  ...
  <ModalStart
    :image-logo="
      customPage.logo_image
        ? customPage.logo_image
        : require('@/assets/PlayGame1/logo/logo.png')
    "
    v-if="dataPopUp !== 0"
  />
  <div
    class="wrapperPlayGame1-layout"
          ...
          <div class="group-toggle-menu">
            <button v-if="!isOpenSidebar" @click="isOpenSidebar = true">
              <img
                ...
                src="@/assets/PlayGame1/icon/commons/menu.png"
              />
            </button>
...
<script setup>
import Sidebar from "@/components/PlayGame1/Sidebar";
import SidebarHoriontal from "@/components/PlayGame1/Sidebar/SidebarHoriontal.vue";
import Header from "@/components/PlayGame1/Header";
import Footer from "@/components/PlayGame1/Footer";
import { ref } from "vue";
import images from "@/assets/PlayGame1";
import { useRouter } from "vue-router";
import NavbarMobile from "@/components/PlayGame1/NavbarMobile";
import ModalPage from "@/components/PlayGame1/modal/ModalPage";
...
onMounted(async () => {
  ...
  store.commit("handleUpdateLoading", false);
  await store.dispatch("getListGameProviderActionsV6");
});
</script>
<style lang="scss">
.wrapperPlayGame1-layout {
