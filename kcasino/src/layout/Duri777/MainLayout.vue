<script setup>
import "@/assets/Duri777/css/common.scss";
import Header from "@/components/Duri777/Header";
import Footer from "@/components/Duri777/Footer";
import ModalPage from "@/components/Duri777/Modal/ModalPage";
import NavbarMobile from "@/components/Duri777/NavbarMobile";
  ...
  <ModalStart
    ...
    :image-logo="
      customPage.logo_image
        ? customPage.logo_image
        : require('@/assets/Duri777/logo/logo.png')
    "
    v-if="dataPopUp !== 0"
  />
  <div
