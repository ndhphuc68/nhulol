      ...
      <div class="main">
        <Header>
          <div class="group-toggle-menu">
            ...
            <button class="wrapper-logo" @click="() => router.push('/')" v-if="customPage?.logo_image">
              <img
...
import SidebarHoriontal from "@/components/PlayG1/Sidebar/SidebarHoriontal.vue";
...
import ModalPage from "@/components/PlayG1/modal/ModalPage";
