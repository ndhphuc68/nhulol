...
const gameKeyV1 = ref(gameTypeModuleSunShine.slot[0].key);
...
const listCompanySlot = ref(gameTypeModuleSunShine.slot);
...
const listGameDetailProviderSlot = ref(
  gameModuleSunShine.listGameDetailProviderSlot
);
...
const handleSelectGame = async (key) => {
  ...
  if (gameSelect) {
    ...
    store.commit("handleUpdateGameKey", gameSelect);
