<template>
  <div class="casino-wrapper">
    <div class="casino-top row justify-content-between">
      ...
      <div class="col-lg-6 col-sm-12 logo-img-v1"></div>
...
const listCompanyCasinoViewFilter = ref(gameTypeModuleSunShine.casino);
  ...
  if (store.state.auth.auth) {
    ...
    if (!checkDisable) {
      ...
      if (gameKey) {
        ...
        //     if (res.code == 0) {
        //       await openGamePopup(res.data, "VAG", module);
        //     } else {
