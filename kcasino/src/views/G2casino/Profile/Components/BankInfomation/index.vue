    ...
    <div class="my-info">
        ...
        <form>
            <div class="field">
                ...
                <input :value="userInfor?.me_bank_name" :disabled="!editActive" type="text"/>
            </div>
            <div class="field">
                <label> {{ $t('bankAccount') }}</label>
                <input :value="userInfor?.me_bank_number" :disabled="!editActive" type="text"/>
            </div>
            <div class="field">
                <label> {{ $t('accountHolder') }}</label>
                <input :value="userInfor?.me_bank_account" :disabled="!editActive" type="text"/>
            </div>
            <div class="field">
