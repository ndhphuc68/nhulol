    ...
    <div class="faqs row">
      <div class="col-12 col-lg-6">
        <img
            alt="banner_slot"
            class="w-100"
            src="@/assets/G2casino/banner/banner-service.png"
        />
      </div>
...
import Notice from "@/views/G2casino/Home/Components/ServiceDetail/Components/Notice.vue";
import Event from "@/views/G2casino/Home/Components/ServiceDetail/Components/Event.vue";
import FAQs from "@/views/G2casino/Home/Components/ServiceDetail/Components/FAQs.vue";
