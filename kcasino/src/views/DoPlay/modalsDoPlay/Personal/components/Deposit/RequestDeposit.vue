...
import Select from "@/components/DoPlay/Customs/Select";
...
const depositAction = async () => {
  ...
  if (res?.is_success) {
    ...
    await store.dispatch("showAlert", {
      type: "error",
      message: res.message ? t(res.message) : t("error"),
    });
  }
  ...
  <div class="container">
    <div class="d-flex flex-wrap align-center">
      ...
      <div class="v-col-md-8 v-col-12">
        <p class="warning-p">{{ $t("transactionWarning") }}</p>
      </div>
    </div>
    ...
    <div class="mt-md-3 mt-3">
      ...
      <div class="d-flex flex-wrap justify-space-between item-request">
        ...
        <div class="v-col-md-9 v-col-12">
          ...
          />
          <div class="d-flex flex-wrap price-list w-md-75 w-100 mt-2">
            <button
      ...
      <div class="text-center mt-4">
        <Button @click="depositAction" class="btn-apply" variant="contained"
          >{{ $t("apply") }}
        </Button>
      </div>
    </div>
