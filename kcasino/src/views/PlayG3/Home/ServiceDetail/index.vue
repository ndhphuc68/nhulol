...
import Event from "@/views/PlayG3/Home/ServiceDetail/Component/Event.vue";
import Notice from "@/views/PlayG3/Home/ServiceDetail/Component/Notice.vue";
import FAQs from "@/views/PlayG3/Home/ServiceDetail/Component/FAQs.vue";
