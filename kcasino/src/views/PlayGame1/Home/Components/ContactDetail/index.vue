    ...
    <div class="faqs row">
      <div class="col-12 col-lg-6">
        <img
          alt="banner_slot"
          class="w-100"
          src="@/assets/PlayGame1/banner/home/banner-notice.png"
        />
      </div>
...
import Notice from "@/views/PlayGame1/Home/Components/ContactDetail/Components/Notice.vue";
import Event from "@/views/PlayGame1/Home/Components/ContactDetail/Components/Event.vue";
import FAQs from "@/views/PlayGame1/Home/Components/ContactDetail/Components/FAQs.vue";
