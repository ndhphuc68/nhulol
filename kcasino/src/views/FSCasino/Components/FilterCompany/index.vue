...
<template>
  ...
  <div class="col-12 mt-3 d-flex flex-row align-center">
    <div class="row w-100">
      <div class="col-6 col-md-4 col-lg-4 col-xl-2 mb-2" v-if="casino">
        <div
      ...
      <div
        :key="index"
        class="col-6 col-md-4 col-lg-4 col-xl-2 mb-2"
      ...
      >
        <div
          ...
          :class="
            handleCheckCompany(item)
              ? companySelect === item.key && 'logo-select'
              : 'disable-item'
          "
        ...
        <div
          v-else
          @click="$emits('handleFillter', item)"
          :key="item.key"
          :class="
            handleCheckCompany(item)
              ? companySelect === item.key && 'logo-select'
  ...
  <div class="collapse col-12" id="collapseExample">
    <div class="card card-body">
      <div class="row w-100">
        <div
          :key="index"
          class="col-6 col-md-4 col-lg-4 col-xl-2 mb-5"
