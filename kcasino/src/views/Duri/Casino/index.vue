<template>
  <div class="casino-wrapper">
      ...
      <div class="row title-casino p-3">
        <div class="d-flex align-center col-12">
          <img
            alt="icon"
            class="icon-casino"
            src="../../../assets/Duri/icon/slot/casino.png"
          />
    ...
    <div class="row">
      ...
      <div
        v-if="
          (typeGamejs === 'evolution' && listCompanyCasinoView.length <= 0) ||
          (typeGamejs !== 'evolution' && loadingCheck)
        "
        style="min-height: 350px"
        class="col-6 col-sm-6 col-md-4 col-xl-3 d-flex justify-center align-center"
      >
        <Loading />
      </div>
    </div>
...
// import { gameModule1, gameTypeMudule1 } from "@/utils/dataGameModule1";
import {
  gameModule117,
  gameTypeModule17,
