...
<template>
  <div class="wrapper-footer row">
    <div class="col col-12 col-lg-4">
      <h4 class="play-title">{{ customPage?.front_title ? customPage?.front_title :'Solongo' }}</h4>
      <div class="row">
        <div class="col col-6">
          <div
          ...
          >
            <img
              alt="service center"
              class="icon-service"
              src="../../../assets/PlayG1/icon/footer/headphone.png"
            />
            <span>{{ $t("FAQs") }}</span>
          </div>
        </div>
        <div class="col col-6">
          ...
          >
            <img
              alt="franchise"
              class="icon-service"
              src="../../../assets/PlayG1/icon/footer/friend.png"
            />
    ...
    <div class="col col-12 col-lg-4 wrapper-logo">
      ...
      />
      <p class="text">
        COPYRIGHT 2023, {{ customPage?.front_title ? customPage?.front_title :'Solongo' }}. ALL RIGHTS RESERVED. GAMBLING CAN BE
