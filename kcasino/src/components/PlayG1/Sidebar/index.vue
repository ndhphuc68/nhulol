<template>
  ...
  >
      ...
      <img
        :src="
          customPage.logo_image
            ? customPage.logo_image
            : require('../../../assets/PlayG1/logo/logo.png')
        "
        class="logo w-60"
        style="height: 100%"
        alt="logo"
    ...
    <div>
      <div class="sidebar-menu">
        ...
        >
          <div
            ...
            :class="
              transaction === 'YES' &&
              (item?.key === 'deposit' || item?.key === 'withdraw' || item?.key === 'depositHistory' || item?.key === 'withdrawHistory')
                ? 'd-none'
                : ''
            "
          >
      ...
      <AuthMobile class="d-block d-xl-none" />
      <slot />
    </div>
  </div>
</template>
