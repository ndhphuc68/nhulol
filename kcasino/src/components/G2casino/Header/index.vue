...
import Profile from "@/assets/G2casino/icon/Header/profile.vue";
import Deposit from "@/assets/G2casino/icon/Header/deposit.vue";
import Withdraw from "@/assets/G2casino/icon/Header/withdraw.vue";
import HistoryBetting from "@/assets/G2casino/icon/Header/history-betting.vue";
import GameGuide from "@/assets/G2casino/icon/Header/game-guide.vue";
import HelpCenter from "@/assets/G2casino/icon/Header/help-center.vue";
import Message from "@/assets/G2casino/icon/Header/message.vue";
// import { logoutRequest } from "@/api/auth/request";
                ...
                <img
                  ...
                  :src="
                    customPage.logo_image
                      ? customPage.logo_image
                      : require('@/assets/G2casino/logo/logo-g2.png')
                  "
                />
              </div>
              <div class="item" v-for="(nav, index) in navs" :key="index">
                <button class="nav-item" @click="handleNavigate(nav?.name)">
                  {{ nav?.text }}
                </button>
              </div>
