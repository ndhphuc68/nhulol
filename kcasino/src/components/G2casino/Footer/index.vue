      ...
      <div class="row justify-content-between pb-5 pb-lg-0">
        <div class="col col-12 col-md-6 wrapper-logo">
          <div class="text-left">
            ...
            />
            <p class="text">
              COPYRIGHT 2023, {{ customPage?.front_title ? customPage?.front_title :'G2Casino' }}. ALL RIGHTS RESERVED. GAMBLING CAN BE
          ...
          <div class="d-flex flex-wrap">
            ...
            >
              <img
                ...
                src="@/assets/G2casino/logo/footer/Headset.png"
              />
              <span>{{ $t("faqs") }}</span>
            </div>
            <div
            ...
            >
              <img
                alt="franchise"
                class="icon-service mr-2"
                src="@/assets/G2casino/logo/footer/Users.png"
              />
