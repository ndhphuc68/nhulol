<script setup>
import { languages } from "@/components/PlayGame1/Header/data";
import Diamond from "@/assets/PlayGame1/icon/header/diamond.vue";
      ...
      <div class="d-flex align-center auth-info">
        ...
        <div class="ml-2" v-if="transaction ==='NO'">
          <Button
            ...
            :on-click="
              () => {
                transaction ==='NO' && router.push('/Deposit-page');
              }
            "
          >
            +
