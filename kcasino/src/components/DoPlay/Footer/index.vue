    ...
    <div class="footer-top">
      <div class="footer-item">
        <img
          ...
          "
        />
        <p>COPYRIGHT 2023, {{ customPage?.front_title ? customPage?.front_title :'DOPlay' }}. ALL RIGHTS RESERVED. GAMBLING CAN BE
          ADDICTIVE, PLEASE PLAY RESPONSIBLY. FOR MORE INFORMATION ON SUPPORT
          TOOLS, PLEASE VISIT OUR RESPONSIBLE GAMBLING PAGE.</p>
      </div>
      <div class="footer-item">
        <h4>{{ customPage?.front_title ? customPage?.front_title :'DOPlay' }}</h4>
        <div class="v-row">
      ...
      <div class="footer-item">
        <div class="v-row">
          <div class="about-item v-col-6">
            <div>
              <a
                ><h5 class="text-center">{{ $t("best-rule") }}</h5></a
              >
...
const handleOpenModal = (idx) => {
  ...
  store.commit("handleActiveSidebar", 4);
};
</script>
<style scoped>
.container {
