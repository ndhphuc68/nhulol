...
<template>
  <div class="wrapper-footer row">
        ...
        <div class="col col-6">
          ...
          >
            <img
              alt="service center"
              class="icon-service"
              src="../../../assets/Duri/icon/footer/headphone.png"
            />
            <span>{{ $t("FAQs") }}</span>
          </div>
        </div>
        <div class="col col-6">
          ...
          >
            <img
              alt="franchise"
              class="icon-service"
              src="../../../assets/Duri/icon/footer/friend.png"
            />
    ...
    <div class="col col-12 col-lg-4 wrapper-logo">
      ...
      />
      <p class="text">
        COPYRIGHT 2023, Duri. ALL RIGHTS RESERVED. GAMBLING CAN BE
