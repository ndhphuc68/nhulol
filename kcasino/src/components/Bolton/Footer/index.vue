        ...
        <article class="col-12 col-lg-4">
          <div class="d-flex align-items-center">
            <img
              ...
              class="logo-image"
            />
            <span class="title-section ms-3" v-if="!customPage.logo_image">Hermes Holdem</span>
          </div>
          <div class="copyright mt-3">
            COPYRIGHT 2023, {{ customPage?.front_title ? customPage?.front_title :'Hermes Holdem' }}. ALL RIGHTS RESERVED. GAMBLING CAN BE
