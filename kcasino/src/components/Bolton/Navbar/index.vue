<template>
  ...
  >
    ...
    <!-- <div class="background-gif-2"></div> -->
  </section>
  <section
    class="container row d-lg-flex py-2 d-none"
  ...
  >
    ...
    >
      ...
      <img
        width="170"
        :src="layout.logo_image && layout.logo_image"
        v-if="menu_item.url"
        style="position: relative; z-index: 1"
      />
      <div v-if="menu_item.url" class="background-gif"></div>
      <!-- <div v-if="menu_item.url" class="background-gif-2"></div> -->
...
.background-gif {
  background-image: url("@/assets/Hermes/4.gif");
  width: 160px;
  height: 140px;
  position: absolute;
  z-index: 0;
...
/* .background-gif-2 {
  background-image: url("@/assets/Hermes/1.gif");
  width: 135px;
  height: 135px;
  position: absolute;
  z-index: 0;
