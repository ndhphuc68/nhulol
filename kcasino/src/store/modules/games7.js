...
const mutations = {
  handleUpdateListGameProviderV7(state, payload) {
    state.listGameProvider = [...payload];
  },
  handleUpdateListGameProviderCasinoV7(state, payload) {
    state.listGameProviderCasino = [
      ...state.listGameProviderCasino,
      ...payload,
    ];
  },
  handleUpdateListGameProviderSlotV7(state, payload) {
    state.listGameProviderSlot = [...state.listGameProviderSlot, ...payload];
  },
  handleUpdateListGameDetailProviderCasinoV7(state, payload) {
    state.listGameDetailProviderCasino = [
      ...state.listGameDetailProviderCasino,
      ...payload,
    ];
  },
  handleUpdateListGameDetailProviderSlotV7(state, payload) {
  ...
  handleUpdateGameKeyV7(state, payload) {
...
const actions = {
  async getListGameProviderActionsV7({ commit }) {
    const res = await getListGameProvider();
    if (res?.is_success || res?.Data?.code === 0) {
      let check = true;
      if (check) {
        if (res?.Data) {
          let dataGame7 = res?.Data?.vendors[7]?.data || null;
                  ...
                  if (res) {
                    ...
                    if (checkCasino.length > 0) {
                      ...
                      if (casino) {
                        ...
                        commit("handleUpdateListGameDetailProviderCasinoV7", [
                          {
                            key: e.key,
                            game: checkCasino,
                          },
                      ...
                      //   },
                      // ]);
                      commit("handleUpdateListGameProviderCasinoV7", [e]);
                    }
                    ...
                    if (checkSlot.length > 0) {
                      ...
                      if (slot) {
                        ...
                        commit("handleUpdateListGameDetailProviderSlotV7", [
                          {
                            key: e.key,
                            game: checkSlot,
                          },
                      ...
                      //   },
                      // ]);
                      commit("handleUpdateListGameProviderSlotV7", [e]);
                    }
                  }
                })
                .catch((e) => {
  ...
  async getListGameCompanyActionsV7({ commit }, data) {
  ...
  async getPlayGameSelectV7({ commit }, data) {
