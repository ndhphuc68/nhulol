...
import Toast from "@/components/EDGames/Toast";
...
:root {
  ...
  --text: #18181b;
  --text-second: #b8b8b8;
  --primaryDoplay: #e180ea;
  --primaryDoplay-light: #f3e8dd;
  --light-gradient: #de6777;
  --white: #fff;
  --neutral-300: #d4d4d8;
  --neutral-200: #e4e4e7;
  --neutral-50: #fafafa;
  ...
  --primary: #cc9a6c;
  --primary-light: #f3e8dd;
  /*--primary: #d5d317;*/
  --solid: #fff;
  --btn-w: 60em;
  /*--btn-hover-bg: linear-gradient(to top, #9b764f, #3d2c21);*/
  --btn-hover-bg: linear-gradient(to top, #607d8d, #1c2529);
  /*--dot-w: calc(var(--btn-w)*.5);
  --tr-X: calc(var(--btn-w) - var(--dot-w));*/

  --primaryPlayG1: #254ee0;
  --primaryFSCasino: #de6777;

  --primaryG2Casino: #254ee0;
  --bgG2Casino: #ffffff;
  --textG2Casino: #18181b;
  --text-secondG2Casino: #a1a1aa;
  --bg-tableHead: #0d1b4e;
  /*SCCasino */
  --primarySCCasino: #0189ff;
  --bgSCCasino: #ffffff;
  --textSCCasino: #18181b;
  --text-secondSCCasino: #7a7a7a;
}
...
.effect-7,
.effect-8,
  /*.effect-9{border: 1px solid #ccc; padding: 6px 10px 4px; transition: 0.4s;}*/
.effect-9 {
  border: 1px solid transparent;
...
.orb:before {
  ...
  left: 2px;
  background-image: radial-gradient(
    farthest-corner at 14px 14px,
    #fff 15%,
    #c0ffe4 50%,
    rgba(192, 255, 228, 0) 100%
  );
  border-radius: 50%;
}
...
@-webkit-keyframes glow2 {
  0% {
    ...
    box-shadow: 0 0 60px 20px #56bcf9, 25px 15px 50px 10px #fff,
      -5px -25px 30px 5px #fff;
  }
  100% {
    transform: rotate(5deg);
    box-shadow: 0 0 90px 20px #56bcf9, 35px 20px 40px 10px #fff,
...
@-webkit-keyframes particle {
  0% {
    box-shadow: inset 0 0 20px 20px #0079e8, 0 0 50px 10px #0079e8,
      inset 0 0 80px 80px #269aff;
  }
  33.33% {
    box-shadow: inset 0 0 20px 20px #0079e8, 0 0 130px 10px #0079e8,
      inset 0 0 50px 50px #269aff;
  }
  33.34% {
    box-shadow: inset 0 0 20px 20px #2693ff, 0 0 50px 10px #2693ff,
      inset 0 0 80px 80px #52abff;
  }
  66.66% {
    box-shadow: inset 0 0 20px 20px #2693ff, 0 0 130px 10px #2693ff,
      inset 0 0 50px 50px #52abff;
  }
  66.67% {
    box-shadow: inset 0 0 20px 20px #485fe8, 0 0 50px 10px #485fe8,
      inset 0 0 80px 80px #7d71e8;
  }
  100% {
    box-shadow: inset 0 0 20px 20px #485fe8, 0 0 130px 10px #485fe8,
      inset 0 0 50px 50px #7d71e8;
  }
}
