...
import DepositHistory from "@/views/Modals/Personal/components/Withdrawal/WithdrawalHistory";
import RequestDeposit from "@/views/Modals/Personal/components/Withdrawal/RequestWithdrawal";

const currentTabIdx = ref(0);
const items = [
  'withdrawRequest', 'withdrawalHistory'
];
const contents = [
