<template>
    <div class="wrapper-auth-mobile">
        ...
        <div class="d-flex align-items-center" style="cursor: pointer" @click="handleLogout">
          <span class="text-logout me-2">{{ $t('logout') }}</span>
          <Component :is="Logout" />
        </div>
    </div>
</template>
...
import Logout from "@/assets/Play4G/icon/Header/logout-sidebar.vue";
